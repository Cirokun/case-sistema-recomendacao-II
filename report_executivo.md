...
**Epsilon-Greedy (ε = 10%):** 90% das vezes o modelo serve o ranking ótimo (exploitation); 10% das vezes embaralha as posições 6–20, mantendo o 
top-5 intacto para não prejudicar a experiência. Isso garante dados diversos para o próximo retreino, reduzindo o cold-start de produtos menos expostos.
